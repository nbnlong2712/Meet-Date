...
public class RegisterGenderPrefection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = RegisterGenderPrefection.this;
        ...
        mSettingHelper.insertData(user.getEmail(), 1, 5, 14, 50);

        maleSelectionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mSettingHelper.updateGenderPrefer(user.getEmail(), 1);
                maleButtonSelected();
            }
        });
        ...
        femaleSelectionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mSettingHelper.updateGenderPrefer(user.getEmail(), 0);
